...
but not aa Job's friends, in a similar trying dispensation, with presumption;
no my dear friend,
...
Eleventh Month 2nd.--I have been now for some time reduced td a low state of mind,
...
that I passed it by,-but I hope to be more attentive in future.
...
First Month 12tA,1815.--The Monthly Meeting near Ballinderry;
